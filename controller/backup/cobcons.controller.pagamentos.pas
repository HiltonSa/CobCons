...
type
    ...
    public
      ...
      function IncluirPagamentoRnp(pAgente, pNrDoc, pGrupo, pSeq, pCota, pTipo: String; pDataCalculo: TDateTime; pValor: Double): iControllerPagamentos;
...
function TControllerPagamentos.IncluirPagamentoRnp(pAgente, pNrDoc, pGrupo,
  pSeq, pCota, pTipo: String; pDataCalculo: TDateTime; pValor: Double
  ): iControllerPagamentos;
begin
  Result := Self;
  FEntidade.IncluirPagamentoRnp(Pagente, Pnrdoc, Pgrupo, Pseq, Pcota, pTipo, Pdatacalculo, pValor);
end;
