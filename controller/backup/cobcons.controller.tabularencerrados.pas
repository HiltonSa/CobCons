...
type
    ...
    public
      ...
      function RateioRecebimentos(pDataBase: TDateTime; pAgente, pDoc, pHistorico: String; pDataset: TDataSet): iControllerTabularEncerrados;
...
function TControllerTabularEncerrados.RateioRecebimentos(pDataBase: TDateTime;
  pAgente, pDoc, pHistorico: String; pDataset: TDataSet
  ): iControllerTabularEncerrados;
begin
  Result := Self;
  FEntidade.RateioRecebimentos(pDataBase, pAgente, pDoc, pHistorico, pDataset);
end;
