...
function TControllerCota.CELULAR: String;
begin
  Result := FEntidade.CELULAR;
end;

function TControllerCota.EMAIL: String;
begin
  Result := FEntidade.EMAIL;
end;
...
function TControllerCota.CELULAR(aValue: String): iControllerCota;
begin
  Result := Self;
  FEntidade.CELULAR(Avalue);
end;

function TControllerCota.EMAIL(aValue: String): iControllerCota;
begin
  Result := Self;
  FEntidade.EMAIL(Avalue);
end;
