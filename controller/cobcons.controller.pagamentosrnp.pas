...
function TControllerPagamentosRnp.PesquisarAsvr(pDtBase: TDateTime): TDataset;
begin
  Result := FEntidade.PesquisarAsvr(pDtBase);
end;

function TControllerPagamentosRnp.GerarAsvr(pTipo, pCnpj: String;
  pDtBase: TDateTime; pArquivo: TStringList; pDataset: TDataset
  ): iControllerPgRnp;
begin
  FEntidade.GerarAsvr(pTipo, pCnpj, pDtBase, pArquivo, pDataset);
  Result := Self;
end;
