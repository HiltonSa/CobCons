...
begin
  ...
  vSp.NOME('MANTER_EMPRESA');
  vSp.PARAMETRO('MODO'     ).VALOR(Ord(pModo)   ).AtribuirValor;
  vSp.PARAMETRO('pFANTASIA').VALOR(FNomeFantasia).AtribuirValor;
  vSp.PARAMETRO('pRAZAO'   ).VALOR(FRazaoSocial ).AtribuirValor;
  vSp.PARAMETRO('pCNPJ'    ).VALOR(FCnpj        ).AtribuirValor;
  vSp.PARAMETRO('pVIGENCIA').VALOR(FVigencia    ).AtribuirValor;
  vSp.PARAMETRO('pUNIDADE' ).VALOR(FUnidade     ).AtribuirValor;
  vSp.PARAMETRO('pCODIGO'  ).VALOR(FCodigo      ).AtribuirValor;
  vSp.PARAMETRO('pENTREGA' ).VALOR(FPcEntrega   ).AtribuirValor;
  vSp.PARAMETRO('pMESPER'  ).VALOR(FMesPer      ).AtribuirValor;
  vSp.PARAMETRO('pPCPER'   ).VALOR(FPcPer       ).AtribuirValor;
  vSp.PARAMETRO('pACERTO'  ).VALOR(FAcerto      ).AtribuirValor;
  vSp.PARAMETRO('pULTFAIXA').VALOR(FUltFaixa    ).AtribuirValor;
  vSp.Executar;
