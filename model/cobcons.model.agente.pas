...
begin
  ...
  vSp.NOME('MANTER_AGENTES');
  vSp.PARAMETRO('pNOME'      ).VALOR(FNome      ).AtribuirValor;
  vSp.PARAMETRO('pCPF'       ).VALOR(FCpf       ).AtribuirValor;
  vSp.PARAMETRO('pDDD'       ).VALOR(FDDD       ).AtribuirValor;
  vSp.PARAMETRO('pCELULAR'   ).VALOR(FCelular   ).AtribuirValor;
  vSp.PARAMETRO('pEQUIPE'    ).VALOR(FEquipe    ).AtribuirValor;
  vSp.PARAMETRO('pSUPERVISAO').VALOR(FSupervisao).AtribuirValor;
  vSp.PARAMETRO('pCDEXTERNO' ).VALOR(FCdExterno ).AtribuirValor;
  vSp.PARAMETRO('pCODIGO'    ).VALOR(FCodigo    ).AtribuirValor;
  vSp.PARAMETRO('pATIVO'     ).VALOR(FAtivo     ).AtribuirValor;
