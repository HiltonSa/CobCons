...
begin
  ...
  vSp.PARAMETRO('PVENDA'    ).VALOR(FVenda    ).AtribuirValor;
  vSp.PARAMETRO('PPARCELA'  ).VALOR(FParcela  ).AtribuirValor;
  vSp.PARAMETRO('PDTVENC'   ).VALOR(FDtVenc   ).AtribuirValor;
  vSp.PARAMETRO('PPERIODO'  ).VALOR(FPeriodo  ).AtribuirValor;
  vSp.PARAMETRO('PRECEBER'  ).VALOR(FReceber  ).AtribuirValor;
  vSp.PARAMETRO('PRECEBIDO' ).VALOR(FRecebido ).AtribuirValor;
  vSp.PARAMETRO('PPAGAR'    ).VALOR(FPagar    ).AtribuirValor;
  vSp.PARAMETRO('PPAGO'     ).VALOR(FPago     ).AtribuirValor;
  vSp.PARAMETRO('PDTREC'    ).VALOR(FDtRec    ).AtribuirValor;
  vSp.Executar;
