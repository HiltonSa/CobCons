...
function Tmodelsqlfbpendecia.Sqlretornapendenciacota(Pgrupo, Pseq, Pcota: String): String;
begin
...
function Tmodelsqlfbpendecia.Sqlretornaaviso(Pgrupo, Pseq, Pcota, Paviso: String): String;
begin
