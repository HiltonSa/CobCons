...
function TmodelsqlOrapendecia.Sqlretornapendenciacota(Pgrupo, Pseq, Pcota: String): String;
begin
...
function TmodelsqlOrapendecia.Sqlretornaaviso(Pgrupo, Pseq, Pcota, Paviso: String): String;
begin
