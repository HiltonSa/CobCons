unit cobcons.model.sql.fbdemonstrativo;
...
type
  ...
  { TModelSQlFbDemonstrativo }

  TModelSQlFbDemonstrativo = class (TInterfacedObject, iModelSqlDemonstrativo)
    private
    public
      constructor Create;
...
const
  ...
  SQL_TABELA_EXISTE =
       ...
       'where RDB$FLAGS = 1 and  RDB$RELATION_NAME = ''CMBDC'' ';
  SQL_TABELA_COSIF_EXISTE =
       'select count(*) QTDE from RDB$RELATIONS '+
       'where RDB$FLAGS = 1 and  RDB$RELATION_NAME = ''COSIF'' ';
...
constructor Tmodelsqlfbdemonstrativo.Create;
begin

end;

destructor Tmodelsqlfbdemonstrativo.Destroy;
begin
  inherited Destroy;
end;

class function Tmodelsqlfbdemonstrativo.New: Imodelsqldemonstrativo;
begin
  Result := Self.Create;
end;

function Tmodelsqlfbdemonstrativo.Sqlcriartabela: String;
begin
  Result := SQL_CRIAR;
end;

function Tmodelsqlfbdemonstrativo.Sqltabelaexiste: String;
begin
  Result := SQL_TABELA_EXISTE;
end;

function Tmodelsqlfbdemonstrativo.Sqlnovo: String;
begin
  Result := SQL_NOVO;
end;

function Tmodelsqlfbdemonstrativo.Sqlretornademonstrativo: String;
begin
  Result := SQL_LISTAR_DEMONSTRATIVO_GRUPO;
end;

function Tmodelsqlfbdemonstrativo.Sqlretornademonstrativodatabase: String;
begin
  Result := SQL_LISTAR_DEMONSTRATIVO_DATABASE;
end;

function Tmodelsqlfbdemonstrativo.Sqlalterarvalorconta: String;
begin
  Result := SQL_ALTERAR_CONTA;
end;

function Tmodelsqlfbdemonstrativo.Sqllistacosifdemonstrativo: String;
begin
  Result := SQL_LISTA_COSIF_DEMONSTRATIVO;
end;

function Tmodelsqlfbdemonstrativo.Sqlnovadatabase: String;
begin
  Result := SQL_INSERIR_NOVA_DATABASE;
end;

function Tmodelsqlfbdemonstrativo.Sqltabelacosifexiste: String;
begin
  Result := SQL_TABELA_COSIF_EXISTE;
end;

function Tmodelsqlfbdemonstrativo.Sqlcriartabelacosif: String;
begin
  Result := SQL_CRIAR_COSIF;
end;

function Tmodelsqlfbdemonstrativo.Sqlimportar4110siacon: String;
begin
  Result := SQL_IMPORTAR_4110_SIACON_DATABASE;
end;

function Tmodelsqlfbdemonstrativo.Sqlimportar4350siacon: String;
begin
