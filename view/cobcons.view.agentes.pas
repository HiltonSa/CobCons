...
uses cobcons.model.configura, cobcons.controller.factory,
  cobcons.controller.util, cobcons.view.fichaagente;
...
begin
  FrmFichaAgente := TFrmFichaAgente.Create(nil);
  try
    FrmFichaAgente.CodigoAgente := pCodigo;
    if FrmFichaAgente.ShowModal = mrOK
    then RefreshDataset;
  finally
    FrmFichaAgente.Free;
  end;
